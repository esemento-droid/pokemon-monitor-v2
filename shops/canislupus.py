...
BASE_URL = "https://www.canislupus.com.pl/Pokemon-c713"
HEADERS = {
...
def parse_page(html):
    ...
    for fig in figs:
        ...
        product_url = f"https://www.canislupus.com.pl{href}" if href.startswith("/") else href
...
async def get_products():
    ...
    async with aiohttp.ClientSession(headers=HEADERS) as session:
        ...
        pages = set()
        for a in soup.select("a[href*='/pa/']"):
